 ...
 * @author EMILIANO
 */
public class GestorGrupoSanguineo extends GestorHibernate implements InterfaceAbm{
    private GrupoSanguineo model;

    public GestorGrupoSanguineo(GrupoSanguineo model) {
        this.model = model;
    }

    public GrupoSanguineo getModel() {
        return model;
    }

    public void setModel(GrupoSanguineo model) {
        this.model = model;
    }
